...
export const Route = createFileRoute("/_authenticated/household")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Share entries with a partner or housemate and split shared bills fairly." },
      { property: "og:title", content: "Household — SimpleBooks AI" },
      { property: "og:description", content: "Share entries with a partner or housemate and split shared bills fairly." },
    ],
  }),
