...
export const es: PartialDictionary = {
  ...
  auth: {
    ...
    resetSent:
      "Si ese correo tiene cuenta, el enlace ya va en camino. Revisa tu bandeja de entrada y también el spam.",
    backToSignIn: "Volver a iniciar sesión",
    newPasswordTitle: "Pon una contraseña nueva",
    newPasswordBlurb: "Ya casi. Elige una contraseña nueva y vuelves directo a tus cuentas.",
    newPassword: "Contraseña nueva",
    confirmPassword: "Escríbela otra vez",
    savePassword: "Guardar la contraseña",
    savingPassword: "Guardando…",
    passwordChanged: "Contraseña cambiada. Te llevamos a tus cuentas…",
    linkExpiredTitle: "Ese enlace ya venció",
    linkExpiredBody:
      "Los enlaces sirven una sola vez y por poco tiempo. Pide uno nuevo y te llega enseguida.",
