...
export const hi: PartialDictionary = {
  ...
  auth: {
    ...
    resetTitle: "पासवर्ड फिर से बनाइए",
    resetBlurb: "जिस ईमेल से खाता बनाया था वह लिखिए, हम नया पासवर्ड बनाने का लिंक भेज देंगे।",
    resetSend: "लिंक भेजिए",
    resetSending: "भेजा जा रहा है…",
    resetSent: "अगर उस ईमेल पर खाता है तो लिंक भेज दिया गया है। इनबॉक्स देखिए, और स्पैम भी।",
    backToSignIn: "वापस साइन इन पर",
    newPasswordTitle: "नया पासवर्ड बनाइए",
    newPasswordBlurb: "बस हो ही गया। नया पासवर्ड चुनिए और सीधे अपने हिसाब पर लौट जाइए।",
    newPassword: "नया पासवर्ड",
    confirmPassword: "दोबारा लिखिए",
    savePassword: "पासवर्ड सेव कीजिए",
    savingPassword: "सेव हो रहा है…",
    passwordChanged: "पासवर्ड बदल गया। आपको आपके हिसाब पर ले जा रहे हैं…",
    linkExpiredTitle: "इस लिंक की मियाद पूरी हो गई",
    linkExpiredBody:
      "लिंक एक ही बार, और थोड़ी देर के लिए ही चलता है। नया माँग लीजिए, तुरंत आ जाएगा।",
    errPasswordMismatch: "दोनों पासवर्ड एक जैसे नहीं हैं।",
