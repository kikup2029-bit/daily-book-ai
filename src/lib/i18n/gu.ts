...
export const gu: PartialDictionary = {
  ...
  auth: {
    ...
    resetTitle: "પાસવર્ડ ફરી બનાવો",
    resetBlurb: "જે ઈમેલથી ખાતું બનાવ્યું હતું તે લખો, અમે નવો પાસવર્ડ બનાવવાની લિંક મોકલી દઈશું.",
    resetSend: "લિંક મોકલો",
    resetSending: "મોકલાઈ રહી છે…",
    resetSent: "એ ઈમેલ પર ખાતું હશે તો લિંક મોકલી દીધી છે. ઇનબૉક્સ જુઓ, અને સ્પામ પણ.",
    backToSignIn: "પાછા સાઇન ઇન પર",
    newPasswordTitle: "નવો પાસવર્ડ મૂકો",
    newPasswordBlurb: "લગભગ પતી ગયું. નવો પાસવર્ડ પસંદ કરો અને સીધા તમારા ચોપડા પર પાછા.",
    newPassword: "નવો પાસવર્ડ",
    confirmPassword: "ફરીથી લખો",
    savePassword: "પાસવર્ડ સાચવો",
    savingPassword: "સાચવાઈ રહ્યો છે…",
    passwordChanged: "પાસવર્ડ બદલાઈ ગયો. તમને તમારા ચોપડા પર લઈ જઈએ છીએ…",
    linkExpiredTitle: "એ લિંકની મુદત પૂરી થઈ ગઈ",
    linkExpiredBody: "લિંક એક જ વાર, અને થોડા સમય માટે જ ચાલે છે. નવી માંગી લો, તરત આવી જશે.",
    errPasswordMismatch: "બંને પાસવર્ડ સરખા નથી.",
